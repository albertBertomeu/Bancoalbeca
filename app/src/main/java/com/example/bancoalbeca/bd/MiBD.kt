package com.example.bancoalbeca.bd

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import android.database.sqlite.SQLiteOpenHelper
import android.util.Log
import com.example.bancoalbeca.dao.ClienteDAO
import com.example.bancoalbeca.dao.CuentaDAO
import com.example.bancoalbeca.dao.MovimientoDAO
...
protected constructor(context: Context?) :
    ...
    private fun insercionDatos(db: SQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO clientes(id, nif, nombre, apellidos, claveSeguridad, email) VALUES (1, '1', 'Filemón', 'Pí', '1', 'filemon.pi@tia.es');")
