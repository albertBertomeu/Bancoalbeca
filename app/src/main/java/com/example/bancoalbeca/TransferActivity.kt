    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEnviar.setOnClickListener {
            ...
            if (binding.cbJustificante.isChecked) {
                ...
                justificante = "Sin justificante"
            }
            var toastPersonalizado = Toast(applicationContext)
            var inflater = layoutInflater
            var layout = inflater.inflate(R.layout.toast_personalizado, findViewById(R.id.toastlyt))
            val txtMsg =layout.findViewById<TextView>(R.id.toastpersonalizado)
            txtMsg.text = "Cuenta origen: ${cuentaOrigen}\n A $a\n  Importe: $importe $moneda \n $justificante"
