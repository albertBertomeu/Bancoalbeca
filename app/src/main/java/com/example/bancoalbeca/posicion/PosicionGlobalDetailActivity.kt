...
class PosicionGlobalDetailActivity : AppCompatActivity(), MovimientoListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (cuenta != null) {
            val movimientosFragment = AccountsMovementsFragment.newInstance(cuenta) //aço li pasa la cuenta al fragment
            ...
            binding.root.post {
                movimientosFragment.mostrarDetalle(cuenta) //en esta funcio es carrega el adapter al fragment, la activity realment lo unic que fa es llançar el fragment i ell s'encarrega de adaptar el recycle view
            }
        }
    }
